      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            buildVSpacer(20),
            _buildText(title: 'Confirm Fastag availability on your car', size: 17),
            buildVSpacer(10),
            _buildText(title: 'Host Owns their Fastag , and settle all Fastag related  transactions with guests seperately . FASTag enabled cars get.'),
           buildVSpacer(40),
            Padding(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      _buildTextHeader(title: '4.2x higher Earnings')
